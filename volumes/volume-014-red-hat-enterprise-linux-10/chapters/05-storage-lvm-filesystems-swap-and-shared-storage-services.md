...
- **Stratis/VDO vs. plain LVM+filesystem.** Choose Stratis when
  ...
  volume.
- **NFS vs. Samba vs. block storage (iSCSI, covered in [Volume VI](../../volume-006-enterprise-storage-data-protection/README.md)).**
