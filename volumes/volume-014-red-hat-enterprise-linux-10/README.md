...
[Volume III, Chapter 08](../volume-003-cisco-enterprise-networking/chapters/08-ios-xe-programmability-and-network-automation.md)
on IOS XE programmability, and to
[Volume IX](../volume-009-infrastructure-automation/README.md) generally.
...
scripts/bash/build-book.sh --format all \
  --volume volume-014-red-hat-enterprise-linux-10

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-014-red-hat-enterprise-linux-10/chapters/09-ansible-system-roles-operations-and-rhcsa-capstone.md
```
