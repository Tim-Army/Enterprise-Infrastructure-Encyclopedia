...
- Build a host-level monitoring baseline that feeds the enterprise
  observability stack covered in depth in [Volume XI](../../volume-011-observability-enterprise-operations/README.md).
...
- Centralize logs from both platforms into a common pipeline, extending
  ...
  Forwarding.
- Operate a host through the full lifecycle model introduced in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)
...
scale — is covered in [Volume XI](../../volume-011-observability-enterprise-operations/README.md); this chapter stays at what a single host
...
to application-layer observability and covered in [Volume XI](../../volume-011-observability-enterprise-operations/README.md)). A host
...
- Both mechanisms feed the same downstream pipeline in a mature
  environment ([Volume XI](../../volume-011-observability-enterprise-operations/README.md)); the choice of agentless-native forwarding
...
[Volume I, Chapter 08](../../volume-001-enterprise-engineering-foundations/chapters/08-infrastructure-lifecycle-management.md) defined the infrastructure lifecycle: plan, build,
...
- **Alert on symptoms, not just raw thresholds.** An alert tied to SLO
  burn rate ([Volume I](../../volume-001-enterprise-engineering-foundations/README.md)'s availability vocabulary) is more actionable than
...
- **Runbooks over tribal knowledge.** A troubleshooting runbook committed
  ...
  ([Volume I, Chapter 05](../../volume-001-enterprise-engineering-foundations/chapters/05-documentation-pipelines-and-publishing.md)) survives staff turnover; an experienced
...
- Encrypt log transport where it crosses an untrusted network segment —
  ...
  production.
- Sanitize storage media per NIST SP 800-88 ([Volume I, Chapter 08](../../volume-001-enterprise-engineering-foundations/chapters/08-infrastructure-lifecycle-management.md)) as part
...
- NIST SP 800-88 — media sanitization guidance referenced in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md),
...
and Windows Event Forwarding — that feed the [Volume XI](../../volume-011-observability-enterprise-operations/README.md) observability
stack, and a complete decommission runbook that closes the lifecycle loop
[Volume I](../../volume-001-enterprise-engineering-foundations/README.md) opened.
