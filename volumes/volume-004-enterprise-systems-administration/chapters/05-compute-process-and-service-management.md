...
(namespaces, container runtimes) is covered in [Volume VIII](../../volume-008-containers-platform-engineering/README.md); this chapter
...
- **NUMA awareness on large hosts.** On multi-socket compute hosts,
  ...
  in [Volume V](../../volume-005-vmware-virtualization/README.md).
- **Idempotent job design.** A scheduled job that partially applies its
  ...
  effect (recall [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)'s idempotency principle) — this matters more for
