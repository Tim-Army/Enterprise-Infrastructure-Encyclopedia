...
- [Volume II — Network Engineering Foundations](../volume-002-network-engineering-foundations/README.md)
  supplies the IP, DNS, and DHCP behavior every registration and call
  leg depends on.
- [Volume III — Cisco Enterprise Networking](../volume-003-cisco-enterprise-networking/README.md)
  carries the QoS architecture this volume's Chapter 08 applies to
  voice and video.
- [Volume IX — Infrastructure Automation](../volume-009-infrastructure-automation/README.md)
...
collaboration lifecycle: call control, protocols and endpoints,
applications, the edge, and media, with programmability expected
throughout. Under Cisco's redesigned practical format — for exams
scheduled on or after **23 March 2027** — the exam becomes three fixed
modules: **Design (2 hr)**, **Deploy, Operate, and Optimize (5 hr)**, and
the new **AI Deploy, Operate, and Optimize (AI DOO, 1 hr)** module
(deploy/operate/optimize using AI as a toolset). Per Cisco's rollout,
CCIE Collaboration gains the AI DOO module in **August 2027** (*to be
confirmed*) — confirm the current format at registration.
...
[Volume XXX](../volume-030-cisco-ccde-network-design/README.md), and use
...
(the [Volume XXVI](../volume-026-proxmox-lab-poweredge-r640/README.md)
...
scripts/bash/build-book.sh --format html --volume volume-028-cisco-collaboration
```
