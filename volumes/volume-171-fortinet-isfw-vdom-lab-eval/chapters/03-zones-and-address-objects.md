...
FGT (zone) # edit APP
FGT (APP) # set interface v2001
FGT (APP) # next
FGT (zone) # edit DB
FGT (DB) # set interface v2002
FGT (DB) # next
FGT (zone) # edit MGMT
FGT (MGMT) # set interface v2003
FGT (MGMT) # next
FGT (zone) # edit OT
FGT (OT) # set interface v2004
FGT (OT) # end
```
...
FGT # show system zone
    edit "APP"  set interface "v2001"
    edit "DB"   set interface "v2002"
    edit "MGMT" set interface "v2003"
    edit "OT"   set interface "v2004"
```
