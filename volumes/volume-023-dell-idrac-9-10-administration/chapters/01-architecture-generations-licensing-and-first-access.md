...
![Flow diagram showing first access to a lab iDRAC validated identically from RACADM and Redfish after a mandatory password change, then the retired factory-default password confirmed to fail authentication.](../../../diagrams/volume-023-dell-idrac-9-10-administration/chapter-01-idrac-first-access-validation-flow.svg)
