...
![Flow diagram showing a RAID 1 test virtual disk built with a dedicated hot spare and confirmed healthy, a delete request against a nonexistent virtual disk ID rejected with an error, and the real virtual disk successfully deleted afterward.](../../../diagrams/volume-023-dell-idrac-9-10-administration/chapter-07-idrac-raid-hotspare-flow.svg)
