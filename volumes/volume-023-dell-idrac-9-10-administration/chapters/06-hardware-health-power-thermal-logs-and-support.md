...
![Flow diagram showing an email alert delivered end to end and confirmed in the Lifecycle Log alongside a generated Tech Support Report bundle, and an unreachable SMTP relay causing the same test alert to fail with a delivery error instead of silently succeeding.](../../../diagrams/volume-023-dell-idrac-9-10-administration/chapter-06-idrac-alerting-lifecycle-log-flow.svg)
...
- **Route alerts by severity and category to appropriately scoped
  ...
  the alert-fatigue guidance covered more generally in [Volume XI](../../volume-011-observability-enterprise-operations/README.md).
