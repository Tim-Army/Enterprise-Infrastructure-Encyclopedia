...
![Flow diagram showing an iDRAC firmware update staged, applied through a controller restart, and confirmed in the Lifecycle Log, alongside a staged update referencing a nonexistent image URI that fails before being applied.](../../../diagrams/volume-023-dell-idrac-9-10-administration/chapter-08-idrac-firmware-update-rollback-flow.svg)
...
- **Offline (local/repository-hosted) catalog** — a catalog and its
  ...
  Enterprise's repository management, [Volume XXII Chapter 6](../../volume-022-dell-openmanage-enterprise/chapters/06-connected-online-repositories-and-update-workflows.md)/7) for
...
job ([Volume XXII](../../volume-022-dell-openmanage-enterprise/README.md), Chapters 5 through 7); this chapter covers the
...
- **Online catalog retrieval fails.** Confirm outbound HTTPS reachability
  ...
  issue described in [Volume XXII, Chapter 1](../../volume-022-dell-openmanage-enterprise/chapters/01-architecture-requirements-deployment-and-first-configuration.md), since both depend on the
...
- [Dell Technologies, *iDRAC Redfish API Guide*](https://www.dell.com/support/kbdoc/en-us/000178045/redfish-api-with-dell-integrated-remote-access-controller) — `UpdateService` and
  `SimpleUpdate` action
- Dell Technologies, *OpenManage Enterprise* Chapters 5–7 ([Volume XXII](../../volume-022-dell-openmanage-enterprise/README.md))
...
servers at once is OpenManage Enterprise's domain, covered in [Volume XXII](../../volume-022-dell-openmanage-enterprise/README.md)
