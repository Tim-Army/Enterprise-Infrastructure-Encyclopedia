...
[Volume XXII](../../volume-022-dell-openmanage-enterprise/README.md)'s related discussion, not duplicated here.
...
(including OME, [Volume XXII](../../volume-022-dell-openmanage-enterprise/README.md)) that build inventory and alert records from
