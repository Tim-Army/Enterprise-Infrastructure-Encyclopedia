...
[Volume XXII](../volume-022-dell-openmanage-enterprise/README.md):
...
[Volume IV](../volume-004-enterprise-systems-administration/README.md)
...
| Week | Focus | Weight |
| --- | --- | --- |
| 4 | Server Management: iDRAC settings, the tool landscape (Lifecycle Controller, RACADM, iSM, OME), and storage management. Chapters 01, 05, 07, 09, plus [Volume XXII](../volume-022-dell-openmanage-enterprise/README.md) 01–04. | 22% |
...
[Volume XXII](../volume-022-dell-openmanage-enterprise/README.md): the
...
scripts/bash/build-book.sh --format all \
  --volume volume-023-dell-idrac-9-10-administration

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-023-dell-idrac-9-10-administration/chapters/01-architecture-generations-licensing-and-first-access.md
```
