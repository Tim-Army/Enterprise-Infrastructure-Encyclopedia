...
mirrors the layered reference models covered in [Volume II](../../volume-002-network-engineering-foundations/README.md). A typical HTTPS
...
- **Preserve chain of custody.** Store the original capture read-only, work
  ...
  referral. [Volume X](../../volume-010-enterprise-cybersecurity/README.md) (Enterprise Cybersecurity) covers formal evidence
