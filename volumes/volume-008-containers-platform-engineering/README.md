...
covered in depth across [Volume IX](../volume-009-infrastructure-automation/README.md),
...
scripts/bash/build-book.sh --format all \
  --volume volume-008-containers-platform-engineering

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-008-containers-platform-engineering/chapters/03-kubernetes-workloads-scheduling-and-capacity.md
```
