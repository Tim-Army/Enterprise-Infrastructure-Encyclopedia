...
- A shared authentication or authorization service with no fallback ([Chapter 4](04-backup-recovery-and-disaster-recovery-engineering.md)'s dependency on identity, and [Volume IV](../../volume-004-enterprise-systems-administration/README.md)'s directory services chapters, both intersect here).
