...
[Volume IV — Enterprise Systems Administration](../volume-04-enterprise-systems-administration/README.md).
...
```bash
scripts/bash/build-book.sh --format all --volume volume-36-windows-server-2025-active-directory
```
