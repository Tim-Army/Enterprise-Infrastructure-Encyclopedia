...
scripts/bash/build-book.sh --format all \
  --volume volume-015-forescout-platform-certifications

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-015-forescout-platform-certifications/chapters/01-platform-architecture-installation-and-deployment-planning.md
```
