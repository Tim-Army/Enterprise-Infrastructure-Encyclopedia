...
| --- | --- | --- |
| General security, networking, and cloud | **35%** | [Volume II](../volume-002-network-engineering-foundations/README.md) and [Volume X](../volume-010-enterprise-cybersecurity/README.md) far more than this volume; [Chapter 01](chapters/01-visibility-architecture-traffic-acquisition-and-tool-delivery.md) supplies the visibility-architecture framing |
...
scripts/bash/build-book.sh --format all \
  --volume volume-018-gigamon-network-visibility

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-018-gigamon-network-visibility/chapters/01-visibility-architecture-traffic-acquisition-and-tool-delivery.md
```
