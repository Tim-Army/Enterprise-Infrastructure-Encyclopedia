...
- Apply infrastructure-as-code practices (from [Volume I](../../volume-001-enterprise-engineering-foundations/README.md) and [Volume IX](../../volume-009-infrastructure-automation/README.md)) to
...
This is the same lesson [Volume I](../../volume-001-enterprise-engineering-foundations/README.md) (repository architecture, automation
architecture) and [Volume IX](../../volume-009-infrastructure-automation/README.md) (infrastructure automation) apply to
...
- **Terraform**, used declaratively for infrastructure that has a clear
  ...
  principle from [Volume I](../../volume-001-enterprise-engineering-foundations/README.md).
...
- **SIEM platforms** (covered generally in [Volume XI](../../volume-011-observability-enterprise-operations/README.md) observability
...
- **Design idempotent automation from the start.** Any automation that
  ...
  established in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)'s automation architecture chapter applies
  directly here.
...
generally in [Volume IX](../../volume-009-infrastructure-automation/README.md).
...
- Store GigaVUE-FM API credentials and cloud IAM credentials used by
  ...
  automation-architecture practices in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md) and [Volume IX](../../volume-009-infrastructure-automation/README.md).
...
- Prefer short-lived, federated credentials (OIDC-based, where the
  ...
  federation pattern from [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)'s automation architecture chapter.
...
- [Volume I — Enterprise Engineering Foundations](../../volume-001-enterprise-engineering-foundations/README.md),
...
established in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md) — idempotency, least-privilege automation
