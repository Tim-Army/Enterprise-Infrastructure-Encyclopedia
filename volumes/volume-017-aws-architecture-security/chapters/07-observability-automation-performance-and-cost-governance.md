...
- Store Terraform state in an encrypted S3 backend with DynamoDB state
  ...
  consistent with the plan/apply separation principle from [Volume I](../../volume-001-enterprise-engineering-foundations/README.md).
