...
scripts/bash/build-book.sh --format all \
  --volume volume-017-aws-architecture-security

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-017-aws-architecture-security/chapters/01-cloud-foundations-accounts-and-well-architected-design.md
```
