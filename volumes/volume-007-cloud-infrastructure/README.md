...
scripts/bash/build-book.sh --format all \
  --volume volume-007-cloud-infrastructure

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-007-cloud-infrastructure/chapters/01-cloud-operating-models-and-architecture-foundations.md
```
