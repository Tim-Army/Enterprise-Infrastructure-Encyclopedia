...
| Container orchestration (covered in depth in [Volume VIII](../../volume-008-containers-platform-engineering/README.md)) | A container image on a scheduler | Node provisioning (if managed), scheduler control plane | Container images, resource requests, in-cluster networking | Microservices, workloads needing fast, dense scaling and packaging portability |
...
orchestration receives dedicated treatment in [Volume VIII](../../volume-008-containers-platform-engineering/README.md). The decision
...
orchestration, detailed in [Volume VIII](../../volume-008-containers-platform-engineering/README.md)); is the workload event-driven,
