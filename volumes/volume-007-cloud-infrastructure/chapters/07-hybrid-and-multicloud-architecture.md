...
- **Containers and Kubernetes** — a container image runs identically
  ...
  [Volume VIII](../../volume-008-containers-platform-engineering/README.md)). This genuinely abstracts the *compute runtime* layer, but
