...
- **[Volume XXII — Dell OpenManage Enterprise](../volume-022-dell-openmanage-enterprise/README.md)**
  and
  **[Volume XXIII — Dell iDRAC 9 and 10 Administration](../volume-023-dell-idrac-9-10-administration/README.md)**
...
- **[Volume VI — Enterprise Storage and Data Protection](../volume-006-enterprise-storage-data-protection/README.md)**
...
[Volume XXII](../volume-022-dell-openmanage-enterprise/README.md) and
[Volume XXIII](../volume-023-dell-idrac-9-10-administration/README.md) are
...
[Volume V](../volume-005-vmware-virtualization/README.md) is written to it.
...
experience, work
[Volume V](../volume-005-vmware-virtualization/README.md) first — these
...
| 3 | Hardware installation, iDRAC and time configuration, network environment validation. Chapter 02 labs, plus [Volume XXIII Chapter 03](../volume-023-dell-idrac-9-10-administration/chapters/03-management-network-ipv4-ipv6-dns-ntp-and-connectivity.md). | 16% |
...
scripts/bash/build-book.sh --format all \
  --volume volume-024-dell-vxrail-hci
```
