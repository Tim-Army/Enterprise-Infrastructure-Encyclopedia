...
hands-on [Volume XXXVI — Windows Server 2025 and Active Directory](../volume-036-windows-server-2025-active-directory/README.md)
and [Volume XXXVII — Microsoft 365 and Modern Work](../volume-037-microsoft-365-modern-work/README.md).
...
```bash
scripts/bash/build-book.sh --format all --volume volume-038-microsoft-certifications-beyond-azure
```
