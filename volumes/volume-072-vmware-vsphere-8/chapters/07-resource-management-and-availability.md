...
**Cleanup:** leave enabled (production) or revert in a lab.
...
**Cleanup:** `Get-VM app01 | Move-VM -Destination (Get-Cluster Cluster1); Remove-ResourcePool prod8 -Confirm:$false`.
