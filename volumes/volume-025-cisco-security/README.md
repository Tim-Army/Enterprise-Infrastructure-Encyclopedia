...
counterpart to [Volume III — Cisco Enterprise Networking](../volume-003-cisco-enterprise-networking/README.md),
...
using the method in [Volume XXX](../volume-030-cisco-ccde-network-design/README.md),
...
scripts/bash/build-book.sh --format all \
  --volume volume-025-cisco-security
```
