...
scripts/bash/build-book.sh --format all \
  --volume volume-016-palo-alto-networks-security

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-016-palo-alto-networks-security/chapters/05-application-identity-threat-and-data-security-policy.md
```
