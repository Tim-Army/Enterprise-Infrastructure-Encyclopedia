...
| --- | --- | --- |
| VMware ESXi / vCenter | OVF/OVA | Private cloud, data center virtualization ([Volume V](../../volume-005-vmware-virtualization/README.md)) |
...
Terraform/CloudFormation template, [Volume IX](../../volume-009-infrastructure-automation/README.md)) attaches vNICs to port
...
with [Volume VII](../../volume-007-cloud-infrastructure/README.md)'s cloud identity guidance and preferable to any
...
- Never commit a populated `init-cfg.txt` or `bootstrap.xml` containing a
  ...
  build time from a secrets manager ([Volume IX](../../volume-009-infrastructure-automation/README.md)).
...
- [Volume V](../../volume-005-vmware-virtualization/README.md) — VMware Virtualization, for ESXi/vCenter deployment
  prerequisites shared with any OVF-based appliance.
- [Volume VII](../../volume-007-cloud-infrastructure/README.md) — Cloud Infrastructure, for cloud identity and secrets
