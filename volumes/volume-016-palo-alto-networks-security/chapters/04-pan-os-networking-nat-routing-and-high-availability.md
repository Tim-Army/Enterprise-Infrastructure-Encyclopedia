...
- Log and periodically review destination NAT rules specifically — every
  ...
  as firewall rule recertification ([Volume X](../../volume-010-enterprise-cybersecurity/README.md)).
