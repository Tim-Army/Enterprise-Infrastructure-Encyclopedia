...
[Volume XXXVI — Windows Server 2025 and Active Directory](../volume-36-windows-server-2025-active-directory/README.md)
...
```bash
scripts/bash/build-book.sh --format all --volume volume-37-microsoft-365-modern-work
```
