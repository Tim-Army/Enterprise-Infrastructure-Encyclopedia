...
Volume CMXCIX is not a teaching volume. Every other volume in this
encyclopedia introduces a domain, builds understanding of it, and ends
with a hands-on lab that exercises that understanding. Volume CMXCIX assumes
...
so that Volume CMXCIX remains consistent with the series' structure and
...
[Volume CMXCVII — Master Appendices](../volume-997-master-appendices/chapters/01-appendix-cisco-u-learning-paths-and-continuing-education-credits.md),
the encyclopedia's single home for appendices.

## Volume resources

- [Index](INDEX.md) — alphabetized topical index across all ten
  chapters.
...
scripts/bash/build-book.sh --format all \
  --volume volume-999-reference-library

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-999-reference-library/chapters/02-ports-protocols-services-and-traffic-flows.md
```
