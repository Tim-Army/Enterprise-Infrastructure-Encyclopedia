...
architecture reasoning using [Volume XXX](../volume-030-cisco-ccde-network-design/README.md),
and draw platform depth from the Cisco technology volumes —
[XXVII](../volume-027-cisco-data-center/README.md) and
[XXIX](../volume-029-cisco-service-provider/README.md) for their
...
scripts/bash/build-book.sh --format all \
  --volume volume-009-infrastructure-automation

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-009-infrastructure-automation/chapters/05-automation-pipelines-testing-and-policy-gates.md
```
