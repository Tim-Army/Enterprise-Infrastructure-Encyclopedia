...
![Flow diagram showing an AppArmor profile generated interactively that allows a permitted file read while blocking and logging an attempted read of /etc/shadow, alongside a LUKS-encrypted loop volume.](../../../diagrams/volume-021-ubuntu-server-cloud-26-04-lts/chapter-06-apparmor-luks-confinement-flow.svg)
