...
![Flow diagram showing a systemd timer triggering a service that logs successfully under a dedicated account, then a missing ExecStart target producing an explicit 203/EXEC failure in the journal.](../../../diagrams/volume-021-ubuntu-server-cloud-26-04-lts/chapter-03-systemd-timer-exec-failure-flow.svg)
