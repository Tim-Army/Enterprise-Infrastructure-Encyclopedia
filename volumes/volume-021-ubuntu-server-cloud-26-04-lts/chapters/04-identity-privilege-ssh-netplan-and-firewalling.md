...
![Topology diagram showing a scoped admin account with hardened SSH and a Netplan configuration applied via the safe netplan try rollback path, alongside a default-deny ufw policy tested by an unreachable unlisted port.](../../../diagrams/volume-021-ubuntu-server-cloud-26-04-lts/chapter-04-ufw-netplan-hardening-topology.svg)
