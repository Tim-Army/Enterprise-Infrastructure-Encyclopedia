...
![Flow diagram showing an authoritative BIND9 zone resolving a defined hostname to a working Nginx virtual host end to end, and returning an authoritative NXDOMAIN for a name that was never defined in the zone.](../../../diagrams/volume-021-ubuntu-server-cloud-26-04-lts/chapter-07-bind9-nginx-nxdomain-flow.svg)
