...
Administration](../volume-004-enterprise-systems-administration/README.md)
...
10](../volume-014-red-hat-enterprise-linux-10/README.md) in structure
...
Fortinet advice in [Volume XIX](../volume-019-fortinet-network-security/README.md),
...
scripts/bash/build-book.sh --format all \
  --volume volume-021-ubuntu-server-cloud-26-04-lts

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-021-ubuntu-server-cloud-26-04-lts/chapters/01-installation-autoinstall-ubuntu-pro-repositories-and-landscape.md
```
