...
![Flow diagram showing a synthetic offline catalog export verified by checksum, hosted over HTTP, and registered in OME as a custom catalog, alongside a deliberately corrupted package file that the checksum verification catches and reports as failed.](../../../diagrams/volume-022-dell-openmanage-enterprise/chapter-07-offline-catalog-integrity-flow.svg)
