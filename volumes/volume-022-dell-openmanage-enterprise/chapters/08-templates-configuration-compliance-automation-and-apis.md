...
- **Automation and infrastructure-as-code alignment.** If your
  ...
  playbooks, Terraform, or similar, covered in [Volume IX](../../volume-009-infrastructure-automation/README.md)), decide how
...
- **Template deployment succeeds but a device becomes unreachable
  ...
  attempt, and use the device's local/out-of-band console ([Volume XXIII](../../volume-023-dell-idrac-9-10-administration/README.md))
