...
![Flow diagram showing a connected catalog manually refreshed with its timestamp advancing and a dependent baseline's compliance evaluation succeeding afterward, alongside a refresh that fails with a connectivity error when the appliance's proxy is pointed at an unreachable address.](../../../diagrams/volume-022-dell-openmanage-enterprise/chapter-06-connected-catalog-refresh-flow.svg)
