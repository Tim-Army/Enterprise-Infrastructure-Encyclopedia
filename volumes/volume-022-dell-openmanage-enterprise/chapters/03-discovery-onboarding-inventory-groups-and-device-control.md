...
- **iDRAC-managed PowerEdge servers** — discovered over HTTPS using
  ...
  to OME. iDRAC discovery and administration in depth is [Volume XXIII](../../volume-023-dell-idrac-9-10-administration/README.md)'s
