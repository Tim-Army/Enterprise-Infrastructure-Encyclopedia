...
[Volume XXIII](../volume-023-dell-idrac-9-10-administration/README.md#certification-alignment)
...
scripts/bash/build-book.sh --format all \
  --volume volume-022-dell-openmanage-enterprise

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-022-dell-openmanage-enterprise/chapters/05-firmware-and-driver-catalogs-baselines-compliance-and-updates.md
```
