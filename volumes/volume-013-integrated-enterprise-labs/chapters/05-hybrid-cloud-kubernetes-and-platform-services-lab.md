...
now. This chapter builds it: a landing zone following [Volume VII](../../volume-007-cloud-infrastructure/README.md) (Cloud
...
The Kubernetes design follows [Volume VIII](../../volume-008-containers-platform-engineering/README.md) (Containers and Platform
...
under one control plane is the concrete expression of [Volume VII](../../volume-007-cloud-infrastructure/README.md), Chapter
...
- **One cluster, not two clusters joined by a service mesh.** A single
  ...
  multi-cluster federation pattern is a legitimate alternative [Volume VII](../../volume-007-cloud-infrastructure/README.md),
...
- **Landing zone guardrails before workloads.** Baseline guardrails
  ...
  matching the sequencing [Volume VII, Chapter 02](../../volume-007-cloud-infrastructure/chapters/02-landing-zones-resource-organization-and-guardrails.md) recommends — retrofitting
...
- **In-cluster platform services, not managed equivalents.** The registry
  ...
  [Volume VIII, Chapter 08](../../volume-008-containers-platform-engineering/chapters/08-internal-developer-platforms-and-platform-products.md) builds on.
...
- Scope the cloud IAM role attached to `k8s-wk02`'s compute instance to
  ...
  administrative role, consistent with [Volume VII, Chapter 03](../../volume-007-cloud-infrastructure/chapters/03-cloud-identity-access-and-cryptographic-services.md).
...
- [Volume VII](../../volume-007-cloud-infrastructure/README.md), Chapters 02–04 and 07 — landing zones, cloud identity, cloud
  networking/hybrid connectivity, and hybrid/multicloud architecture.
- [Volume VIII](../../volume-008-containers-platform-engineering/README.md), Chapters 02, 04, and 08 — Kubernetes architecture,
  networking/traffic policy, and internal developer platforms.
- [Volume III, Chapter 04](../../volume-003-cisco-enterprise-networking/chapters/04-enterprise-wan-internet-edge-and-catalyst-sd-wan.md) — Enterprise WAN, Internet Edge, and Catalyst
