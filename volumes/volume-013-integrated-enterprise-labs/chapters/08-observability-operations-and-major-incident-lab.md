...
[Volume XI](../../volume-011-observability-enterprise-operations/README.md) (Observability and Enterprise Operations): [Chapter 02](02-integrated-identity-dns-time-and-core-services-lab.md) (Telemetry
...
[Volume XI, Chapter 03](../../volume-011-observability-enterprise-operations/chapters/03-metrics-service-level-objectives-and-error-budgets.md) treats the error budget as the resource this
...
- **Pull-based metrics for infrastructure, push-based for short-lived
  ...
  than the scrape interval pushes instead — a distinction [Volume XI](../../volume-011-observability-enterprise-operations/README.md),
...
- **Multi-window, multi-burn-rate alerting, not a static threshold.** A
  ...
  (1-hour) and slow (6-hour) burn-rate window, the pattern [Volume XI](../../volume-011-observability-enterprise-operations/README.md),
...
- **The postmortem is blameless and evidence-driven.** The timeline in
  ...
  standard [Volume XI, Chapter 07](../../volume-011-observability-enterprise-operations/chapters/07-service-management-incident-problem-and-change-operations.md) expects of a real postmortem.
...
- **Common failure: burn-rate windows too close together.** If both the
  ...
  multiplier constants against [Volume XI, Chapter 03](../../volume-011-observability-enterprise-operations/chapters/03-metrics-service-level-objectives-and-error-budgets.md)'s guidance before
...
- [Volume XI](../../volume-011-observability-enterprise-operations/README.md), Chapters 02–03, 05–07 — telemetry architecture, metrics/SLOs,
