...
scripts/bash/build-book.sh --format all \
  --volume volume-013-integrated-enterprise-labs

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-013-integrated-enterprise-labs/chapters/09-enterprise-resilience-and-lifecycle-capstone.md
```
