...
2. **Shared risk and multi-tenancy.** Infrastructure is consumed by many
   ...
   ([Chapter 08](08-infrastructure-lifecycle-management.md)) and defense-in-depth ([Volume X](../../volume-010-enterprise-cybersecurity/README.md)) exist as disciplines rather
...
This encyclopedia organizes 27 volumes around a consistent taxonomy of
...
| Networking | Protocol architecture, addressing, switching, routing | [Volume II](../../volume-002-network-engineering-foundations/README.md), with vendor depth in [Volume III](../../volume-003-cisco-enterprise-networking/README.md) |
| Systems administration | Operating system management across the estate | [Volume IV](../../volume-004-enterprise-systems-administration/README.md), with distribution depth in Volumes XIV and XXI |
| Virtualization | Hypervisors, compute abstraction, virtual networking and storage | [Volume V](../../volume-005-vmware-virtualization/README.md) |
| Storage and data protection | Block/file/object storage, backup, replication, recovery | [Volume VI](../../volume-006-enterprise-storage-data-protection/README.md) |
| Cloud infrastructure | Public cloud architecture patterns and shared responsibility | [Volume VII](../../volume-007-cloud-infrastructure/README.md), with AWS depth in [Volume XVII](../../volume-017-aws-architecture-security/README.md) |
| Containers and platform engineering | Container runtimes, orchestration, internal developer platforms | [Volume VIII](../../volume-008-containers-platform-engineering/README.md) |
| Automation at infrastructure scale | Infrastructure as code, configuration management, orchestration | [Volume IX](../../volume-009-infrastructure-automation/README.md) |
| Cybersecurity | Identity, network security, endpoint security, vendor security platforms | [Volume X](../../volume-010-enterprise-cybersecurity/README.md), with vendor depth in Volumes XV, XVI, XVIII, XIX, XX |
| Observability and operations | Monitoring, logging, tracing, operational practice | [Volume XI](../../volume-011-observability-enterprise-operations/README.md) |
| Resilience and lifecycle | Availability engineering, disaster recovery, lifecycle discipline at scale | [Volume XII](../../volume-012-resilience-lifecycle-management/README.md) |
...
| Public cloud (IaaS/PaaS/SaaS) | The cloud provider | Split under a shared responsibility model ([Volume VII](../../volume-007-cloud-infrastructure/README.md), [Volume XVII](../../volume-017-aws-architecture-security/README.md)) | Elastic, API-driven workloads; fastest time to provision |
...
and that [Volume VII](../../volume-007-cloud-infrastructure/README.md) treats in full architectural depth.
...
assumed default. [Volume XII](../../volume-012-resilience-lifecycle-management/README.md) treats availability engineering and disaster
...
- Review the inventory's consumption-model distribution periodically as a
  ...
  resilience finding for [Volume XII](../../volume-012-resilience-lifecycle-management/README.md), not a detail to note and move past.
...
encyclopedia organizes its remaining 26 volumes around a consistent domain
