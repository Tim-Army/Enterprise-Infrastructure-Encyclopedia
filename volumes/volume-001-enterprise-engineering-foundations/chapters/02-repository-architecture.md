...
- **Numbering and stable identifiers.** When content or services are
  numbered (`volume-001`, `service-03`), decide up front whether numbers are
...
/volumes/volume-005-vmware-virtualization/  @virtualization-sme-team
...
```text
feat(volume-002): add chapter on IP routing fundamentals
