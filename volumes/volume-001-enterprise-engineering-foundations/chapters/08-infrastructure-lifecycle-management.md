...
2. **Procure or provision.** Physical assets are purchased, received, and
   ...
   as code ([Chapter 03](03-automation-architecture.md), formalized further in [Volume IX](../../volume-009-infrastructure-automation/README.md)).
...
4. **Operate and maintain.** The asset runs in production, subject to
   monitoring ([Volume XI](../../volume-011-observability-enterprise-operations/README.md)), patching, and change management (this
   chapter).
