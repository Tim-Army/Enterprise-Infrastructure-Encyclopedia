...
- **Chapters 06–08** zoom out from tooling to the conceptual foundations
  ...
  is and how its domains map to Volumes II through CMXCIX, how enterprise
...
scripts/bash/build-book.sh --format all \
  --volume volume-001-enterprise-engineering-foundations

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-001-enterprise-engineering-foundations/chapters/06-understanding-enterprise-infrastructure.md
```
