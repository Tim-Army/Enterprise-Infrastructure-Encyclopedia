...
lives in
[Volume X](../volume-010-enterprise-cybersecurity/README.md). CCST
Networking is also the natural on-ramp to **CCNA** in
[Volume III](../volume-003-cisco-enterprise-networking/README.md), which
...
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-002-network-engineering-foundations/chapters/09-network-troubleshooting-and-operations.md
```
