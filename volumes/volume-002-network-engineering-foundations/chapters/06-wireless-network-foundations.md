...
chapter is deliberately vendor-neutral; [Volume III](../../volume-003-cisco-enterprise-networking/README.md)'s "Catalyst Wireless
...
Catalyst wireless architecture) is covered in [Volume III](../../volume-003-cisco-enterprise-networking/README.md).
...
which is why enterprise identity architecture ([Volume X](../../volume-010-enterprise-cybersecurity/README.md)) treats wired and
