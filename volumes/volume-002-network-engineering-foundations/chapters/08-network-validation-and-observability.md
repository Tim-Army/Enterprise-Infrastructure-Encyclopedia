...
- **Re-baseline after every significant change**, and record the baseline
  ...
  approach established in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)) rather than tribal knowledge held by
  one engineer.
