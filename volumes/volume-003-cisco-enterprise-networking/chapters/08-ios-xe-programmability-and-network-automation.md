...
pushed to devices ([Volume IX](../../volume-009-infrastructure-automation/README.md) covers the general automation architecture
...
introduced in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md). **pyATS/Genie**, Cisco's Python test and
...
guarantee introduced in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md) and required of any production
automation workflow.
...
- Store NETCONF/RESTCONF/Ansible credentials and API tokens in a managed
  secrets store ([Volume IX](../../volume-009-infrastructure-automation/README.md)), never in plaintext playbooks or scripts
...
- Pin Ansible collection and pyATS/Genie versions in a lockfile-equivalent
  manner ([Volume IX](../../volume-009-infrastructure-automation/README.md)'s automation architecture) so a collection upgrade
...
[Volume I](../../volume-001-enterprise-engineering-foundations/README.md) and [Volume IX](../../volume-009-infrastructure-automation/README.md).
