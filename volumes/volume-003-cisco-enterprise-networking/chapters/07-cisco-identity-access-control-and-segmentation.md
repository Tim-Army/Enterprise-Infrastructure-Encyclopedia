...
- Rotate TACACS+/RADIUS shared secrets on a defined schedule and store
  ...
  backups ([Volume IX](../../volume-009-infrastructure-automation/README.md)).
...
- Prefer EAP-TLS (certificate-based) 802.1X over PEAP/MSCHAPv2 for
  ...
  ([Volume IV](../../volume-004-enterprise-systems-administration/README.md), [Volume IX](../../volume-009-infrastructure-automation/README.md)) exists; certificate-based authentication removes
