...
| Data Center | Server and application connectivity | [Volume VI](../../volume-006-enterprise-storage-data-protection/README.md), [Volume VIII](../../volume-008-containers-platform-engineering/README.md) |
| Enterprise Cloud | Public/hybrid cloud connectivity | [Volume VII](../../volume-007-cloud-infrastructure/README.md) |
...
configuration, and defers deep security architecture to [Volume X](../../volume-010-enterprise-cybersecurity/README.md).
...
- Maintain configuration backups (`copy running-config` to a controlled
  ...
  under version control ([Volume IX](../../volume-009-infrastructure-automation/README.md)).
