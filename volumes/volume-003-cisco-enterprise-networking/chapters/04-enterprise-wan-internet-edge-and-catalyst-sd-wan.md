...
- **Perimeter security** (firewalling, intrusion prevention) — covered in
  architectural depth in [Volume X](../../volume-010-enterprise-cybersecurity/README.md) and [Volume XVI](../../volume-016-palo-alto-networks-security/README.md); this volume treats the
