...
| DSCP markings reset to 0 somewhere in the path | An intermediate device re-marking/clearing DSCP, or a trust boundary misconfigured to distrust an already-trusted source | `show mls qos interface`, trace marking hop by hop with packet captures ([Volume XX](../../volume-020-wireshark-packet-analysis/README.md)) |
