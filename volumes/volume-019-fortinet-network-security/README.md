...
scripts/bash/build-book.sh --format all \
  --volume volume-019-fortinet-network-security

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-019-fortinet-network-security/chapters/04-fortigate-first-deployment-licensing-management-and-hardening.md
```
