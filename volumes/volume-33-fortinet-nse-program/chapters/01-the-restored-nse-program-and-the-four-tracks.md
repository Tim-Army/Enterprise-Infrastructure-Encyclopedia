# Chapter 01: The Restored NSE Program and the Four Tracks
...
- Map the four tracks — Secure Networking, Security Operations, Cloud
  ...
  of them
- Position this volume against Volume XIX, which covers NSE 1–4 for
  Secure Networking
...
published table). Volume XIX of this encyclopedia covers **NSE 1–4**
(cybersecurity fundamentals through the FortiGate/FortiOS
Administrator); this volume covers **NSE 5–8** across all four tracks.
...
- Everyone starts at NSE 4 (Volume XIX, Chapter 09); choose the track
...
- Practice on FortiGate VM / the free Fortinet labs, licensed images
  only (Volume XIX's lab platform extends to this volume)
...
- Volume XIX of this encyclopedia (NSE 1–4)
...
- [ ] Relationship to Volume XIX (NSE 1–4) understood
