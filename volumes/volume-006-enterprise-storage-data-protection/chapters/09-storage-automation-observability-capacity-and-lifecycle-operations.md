...
declarative, plan-then-apply discipline [Volume I](../../volume-001-enterprise-engineering-foundations/README.md) establishes for
...
format for a central monitoring stack, developed in full in [Volume XI](../../volume-011-observability-enterprise-operations/README.md)
...
lifecycle model from [Volume I](../../volume-001-enterprise-engineering-foundations/README.md):
...
- **Technology refresh.** Driven by End-of-Life/End-of-Support (EOL/EOS)
  dates (tracked per [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)'s lifecycle management practice) with
...
Running this through a plan/apply pipeline ([Volume I, Chapter 3](../../volume-001-enterprise-engineering-foundations/chapters/03-automation-architecture.md)) means a
...
- [Volume I, Chapter 3](../../volume-001-enterprise-engineering-foundations/chapters/03-automation-architecture.md) (Automation Architecture) and [Chapter 8](08-storage-security-ransomware-resilience-and-data-governance.md)
