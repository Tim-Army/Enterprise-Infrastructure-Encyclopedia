...
1. **Prevention** — endpoint and network controls, patching, and access
   ...
   compromise. (Owned primarily by [Volume X](../../volume-010-enterprise-cybersecurity/README.md), Enterprise Cybersecurity;
...
- Sanitize or destroy media at end of life per an established standard
  (NIST SP 800-88 Clear/Purge/Destroy, introduced in [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)'s lifecycle
...
- NIST SP 800-88 (Guidelines for Media Sanitization), referenced from
  [Volume I](../../volume-001-enterprise-engineering-foundations/README.md)'s infrastructure lifecycle management chapter.
