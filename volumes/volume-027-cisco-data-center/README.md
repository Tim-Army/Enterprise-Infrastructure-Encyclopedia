...
- [Volume IX — Infrastructure Automation](../volume-009-infrastructure-automation/README.md)
  ...
  ACI.
- [Volume XXV — Cisco Security](../volume-025-cisco-security/README.md)
...
method in [Volume XXX](../volume-030-cisco-ccde-network-design/README.md),
...
scripts/bash/build-book.sh --format html --volume volume-027-cisco-data-center
```
