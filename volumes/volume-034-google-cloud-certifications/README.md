...
[Volume XVII (AWS)](../volume-017-aws-architecture-security/README.md) and
[Volume XXXIII (Microsoft Azure)](../volume-033-microsoft-azure-certifications/README.md).
...
```bash
scripts/bash/build-book.sh --format all --volume volume-034-google-cloud-certifications
```
