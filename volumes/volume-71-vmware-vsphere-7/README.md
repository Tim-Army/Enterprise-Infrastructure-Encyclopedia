...
[Volume V (VMware Virtualization)](../../volume-05-vmware-virtualization/README.md) (the broader
VMware volume) and from [Volume LXXII (VMware vSphere 8)](../../volume-72-vmware-vsphere-8/README.md)
...
blueprint. The complementary volumes are [VMware Virtualization (V)](../../volume-05-vmware-virtualization/README.md),
...
```bash
scripts/bash/build-book.sh --format all --volume volume-71-vmware-vsphere-7
```
