...
scripts/bash/build-book.sh --format all \
  --volume volume-011-observability-enterprise-operations

# Build a single chapter.
scripts/bash/build-book.sh --format all \
  --chapter volumes/volume-011-observability-enterprise-operations/chapters/03-metrics-service-level-objectives-and-error-budgets.md
```
