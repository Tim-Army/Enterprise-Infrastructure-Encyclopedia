...
- **Processing** — parsing (structured JSON parsed directly; legacy
  ...
  logs, covered further in [Volume X](../../volume-010-enterprise-cybersecurity/README.md)).
- **Storage** — a log backend optimized for the query pattern the
  ...
  search ([Volume X](../../volume-010-enterprise-cybersecurity/README.md) covers SIEM sizing in depth).
...
- **Retention tiering.** Not all logs warrant the same retention. A
  ...
  financial transaction logs — [Volume X](../../volume-010-enterprise-cybersecurity/README.md) and applicable regulatory
...
- NIST SP 800-92, *Guide to Computer Security Log Management*, for
  ...
  [Volume X](../../volume-010-enterprise-cybersecurity/README.md).
