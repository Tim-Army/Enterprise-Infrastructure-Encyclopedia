...
ITIL 4 (introduced at the framework level in [Volume I, Chapter 08](../../volume-001-enterprise-engineering-foundations/chapters/08-infrastructure-lifecycle-management.md)) treats
...
- **Change risk classification granularity.** Too few risk categories
  ...
  categories (standard, normal, emergency, per [Volume I Chapter 08](../../volume-001-enterprise-engineering-foundations/chapters/08-infrastructure-lifecycle-management.md)) is
...
- Treat the change record as an auditable control, not paperwork:
  regulatory frameworks referenced in [Volume X](../../volume-010-enterprise-cybersecurity/README.md) (PCI DSS, SOX,
