#!/usr/bin/env python3
"""Volume LXXXVII (Microsegmentation Options) topology diagrams.

Chapter 7 (ColorTokens Xshield): a segmented IT/OT estate showing where
...
Run from scripts/diagrams:  python3 gen_volume087.py
"""
import sys
sys.path.insert(0, ".")
from labtopo import Canvas, Line

OUT = "../../diagrams/volume-087-microsegmentation-options"


def ch07():
    c = Canvas(960, 680,
        title="Chapter 7 Lab Topology: ColorTokens Xshield Across a Segmented IT/OT Estate",
        ...
        svg_title="Chapter 7 lab topology: a five-VM IT/OT estate segmented with ColorTokens Xshield, host agents on the servers and an agentless Gatekeeper for the PLC",
    ...
    c.save(f"{OUT}/chapter-07-colortokens-xshield-topology.svg")
